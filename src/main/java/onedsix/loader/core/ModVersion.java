...
/**
 * Referring to <a href="https://docs.minecraftforge.net/en/1.14.x/conventions/versioning/">MinecraftForge Docs</a>.
            ...
            for (int i = 0; i < inDevLevels.length; i++) {
                ...
                if (part2.equals(level)) {
					...
					try {
						...
						if (inDevVersion == 0)
							log.error(String.format("InDev version number 0 is ignored. No inDev instead. Source: %s", version));
						inDevLevel = i;
						exist = true;
						break;
					} catch (NumberFormatException e) {
