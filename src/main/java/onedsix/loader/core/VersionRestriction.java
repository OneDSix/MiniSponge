...
{
    private final ModVersion lowerBound;

    private final boolean lowerBoundInclusive;

    private final ModVersion upperBound;

    private final boolean upperBoundInclusive;

    public static final VersionRestriction EVERYTHING = new VersionRestriction( null, false, null, false );

    public VersionRestriction( ModVersion lowerBound, boolean lowerBoundInclusive, ModVersion upperBound,
    ...
    public ModVersion getLowerBound()
    {
        return lowerBound;
    }
    ...
    public ModVersion getUpperBound()
    {
        return upperBound;
    }
    ...
    public boolean equals( Object other )
    {
        ...
        if ( !( other instanceof VersionRestriction ) )
        {
            return false;
        }

        VersionRestriction restriction = (VersionRestriction) other;
        if ( lowerBound != null )
        {
